...
-(void)loadAdDataThenStart{
    ...
    for (int i=0; i<self.adDataArray.count; i++) {
        UILabel *lab = [[UILabel alloc]initWithFrame:CGRectMake(20, 140, 300, 25)];
//        lab.textColor = UIColorWithRGBA(255, 255, 255, 0.9);
        lab.textColor =[UIColor whiteColor];
        lab.backgroundColor = [UIColor grayColor];
//        lab.textAlignment = NSTextAlignmentCenter;
        lab.font = [UIFont fontWithName:@"Helvetica-Bold" size:17];
        lab.adjustsFontSizeToFitWidth = YES;
        lab.text = self.adTitleArray[i];
