...
@interface HWAdView : UIView<UIScrollViewDelegate>
@property(nonatomic,strong) UIScrollView *adScrollView;
@property(nonatomic,strong) UIPageControl *pageControl;
@property(nonatomic,strong) NSTimer *adLoopTimer;
@property(nonatomic,copy)   NSString *placeImageSource;
@property(nonatomic,strong) NSMutableArray *adDataArray;  //广告图片数组
@property(nonatomic,strong) NSMutableArray *adTitleArray;//广告标题数组
